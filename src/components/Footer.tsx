      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-emerald-800/50">
          ...
          <div className="space-y-4">
            <h4 className="font-bold text-white text-sm tracking-wider uppercase">Sobre Nosotros</h4>
            <p className="text-xs text-stone-300 leading-relaxed">
              Emprendimiento escolar desarrollado por estudiantes de 3.º, 4.º y 5.º de secundaria de la I.E.S. San Luis Gonzaga de Limbani para rescatar y valorar la botánica medicinal ancestral andina.
            </p>
          ...
          <div>
            <h4 className="font-bold text-white text-sm mb-4 tracking-wider uppercase">Navegación</h4>
            <ul className="space-y-2.5 text-xs">
              ...
              <li>
                <Link href="/#historia" className="hover:text-emerald-400 transition-colors">
                  Investigación & Yatiris
                </Link>
              </li>
              <li>
                <Link href="/#impacto" className="hover:text-emerald-400 transition-colors">
          ...
          <div>
            <h4 className="font-bold text-white text-sm mb-4 tracking-wider uppercase">Hierbas Tradicionales</h4>
